...
`Journeys.Agent` Anthropic and MCP credentials belong in user secrets or environment variables — see [local ops](local-ops.md). Do not commit live keys in `Journeys.Agent/appsettings.json`.
